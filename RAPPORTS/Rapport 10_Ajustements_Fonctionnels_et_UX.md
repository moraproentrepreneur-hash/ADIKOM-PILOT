...
| Cinquième commit | `5ea4798` — trois références visibles retirées et le test qui les tiendra ; déploiement **READY** |
| Production | <https://adikom-pilot.vercel.app> — la page publique annonce **178 capacités attribuables** |
| Recette finale | contre `5ea4798` : **56 contrôles, tous réussis**, aucun lien interrompu, aucun résidu de compte |
...
La recette de production a été jouée **huit fois** contre <https://adikom-pilot.vercel.app>.
Six passages ont donné **56 contrôles, tous réussis**. Deux ne l'ont pas

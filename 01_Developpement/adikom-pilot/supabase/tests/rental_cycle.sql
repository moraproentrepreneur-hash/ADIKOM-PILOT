...
-- --- 13. Catalogue : 170 permissions, les quatre capacités servies présentes ---------------
--
...
begin
  ...
  if total <> 170 then
    raise exception 'Catalogue attendu à 170 permissions, obtenu %.', total;
  end if;

  raise notice '[OK] 13. Catalogue : 170 permissions, les 4 capacités du cycle sont sensibles.';
end $$;

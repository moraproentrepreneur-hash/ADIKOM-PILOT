...
-- --- 13. Catalogue : 157 permissions, les quatre capacités servies présentes ---------------
--
...
begin
  ...
  raise notice '[OK] 13. Catalogue : 157 permissions, les 4 capacités du cycle sont sensibles.';
end $$;

...
async function main() {
  ...
  try {
...

    {
      ...
      check(
        demoApres.supplierInvoices === demoAvant.supplierInvoices,
        'Aucune facture de recette n’a rejoint les données DEMO',
        `${demoApres.supplierInvoices} / ${demoAvant.supplierInvoices} au départ`
      )

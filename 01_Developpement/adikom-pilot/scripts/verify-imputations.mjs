...
async function main() {
  ...
  try {
...

    {
      ...
      check(
        demoApres.imputations === demoAvant.imputations,
        'Aucune imputation de recette n’a rejoint les données DEMO',
        `${demoApres.imputations} / ${demoAvant.imputations} au départ`
      )
    }
  } finally {
    await browser.close()
